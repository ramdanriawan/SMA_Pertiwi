<section class="content-header mt-5">
  <div class="col-lg-12">
      <ol class="breadcrumb">
        <li><i class="fa fa-fw fa-chalkboard"></i> Data Kelas</li>
      </ol>
   </div>
</section>
...
if(@$_SESSION[admin]) {
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="col-md-12">
            <div class="card my-2">
                <div class="card-header"><a href="?page=kelas&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a> &nbsp; <a href="./laporan/cetak.php?data=kelas" target="_blank" class="btn btn-default btn-sm">Cetak</a></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless table-hover" id="tb_kelas">
                            ...
                            while($data_kelas = mysqli_fetch_array($sql_kelas)) { ?>
                                <tr>
                                    ...
                                    <td align="center" width="200px">
                                        <a href="?page=kelas&action=edit&id=<?php echo $data_kelas['id_kelas']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=kelas&action=hapus&id=<?php echo $data_kelas['id_kelas']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
                                        <a href="?page=siswa&IDkelas=<?php echo $data_kelas['id_kelas']; ?>&kelas=<?php echo $data_kelas['nama_kelas']; ?>" class="btn btn-sm m-1 btn-dark">Lihat Siswa</a>
                                    </td>
                                </tr>
                            <?php
                            } ?>
    ...
    <?php
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Tambah Data Kelas &nbsp; <a href="?page=kelas" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Edit Data Kelas &nbsp; <a href="?page=kelas" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
                        <div class="form-group">
                            <label>Nama Kelas *</label>
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="row">
            <div class="col-md-12">
                <div class="card my-2">
                    <div class="card-header">Kelas yang Anda Ajar &nbsp; <a href="?page=kelas&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-borderless table-hover" id="tb_kelas">
                                <thead class="thead-dark">
                                    ...
                                    while($data_ajar = mysqli_fetch_array($sql_ajar)) { ?>
                                        <tr>
                                            ...
                                            <td align="center" width="240px">
                                                <a href="?page=kelas&action=edit&id=<?php echo $data_ajar['id']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
                                                <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=kelas&action=hapus&id=<?php echo $data_ajar['id']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
                                                <a href="?page=siswa&IDkelas=<?php echo $data_ajar['id_kelas']; ?>&kelas=<?php echo $data_ajar['nama_kelas']; ?>" class="btn btn-sm btn-dark m-1">Lihat Siswa</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
    ...
    <?php
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card my-2">
                    <div class="card-header">Tambah Data Kelas yang Anda Ajar &nbsp; <a href="?page=kelas" class="btn btn-warning btn-sm">Kembali</a></div>
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card my-2">
                    <div class="card-header">Edit Data Kelas yang Anda Ajar &nbsp; <a href="?page=kelas" class="btn btn-warning btn-sm">Kembali</a></div>
                    <div class="card-body">
                    <?php
