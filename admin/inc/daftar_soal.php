...
if(@$_GET['hal'] == "pilgan") { ?>
	...
	<div class="col-md-12">
		<div class="card my-2">
			<div class="card-header">Soal Pilihan Ganda &nbsp; <a href="?page=quiz&action=buatsoal&hal=soalpilgan&id=<?php echo $id; ?>" class="btn btn-primary btn-sm">Tambah Soal Pilihan Ganda</a></div>
			<div class="card-body">
				...
				if(mysqli_num_rows($sql_pilgan) > 0) {
					...
					<table width="100%">
						<tr>
							<td valign="top">Soal no. ( <?php echo $no++; ?> )</td><br>
							<td>
								<table class="">
									...
									<tbody>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<a href="?page=quiz&action=daftarsoal&hal=editsoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>&ke=<?php echo $k++; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
												<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=quiz&action=daftarsoal&hal=hapussoalpilgan&id=<?php echo $id; ?>&idsoal=<?php echo $data_pilgan['id_pilgan']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
											</td>
										</tr>
									</tbody>
								</table>
...
<?php
	...
	<div class="col-md-12">
		<div class="card my-2">
			<div class="card-header">Soal Essay &nbsp; <a href="?page=quiz&action=buatsoal&hal=soalessay&id=<?php echo $id; ?>" class="btn btn-primary btn-sm">Tambah Soal Essay</a></div>
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-striped table-borderless table-hover" id="tb_essay">
						<thead class="thead-dark">
							<tr>
								<th>No</th>
								<th>Pertanyaan</th>
						...
						if(mysqli_num_rows($sql_essay) > 0) {
							...
							<tr>
								...
								<td align="center" width="120px">
									<a href="?page=quiz&action=daftarsoal&hal=editsoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>&ke=<?php echo $k++; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
									<a onclick="return confirm('Yakin akan menghapus data?');" href="?page=quiz&action=daftarsoal&hal=hapussoalessay&id=<?php echo $id; ?>&idsoal=<?php echo $data_essay['id_essay']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
								</td>
							</tr>
							<?php
							}
	...
	<div class="col-md-12">
		<div class="card my-2">
			<div class="card-header">Edit Soal Pilihan Ganda</div>
			<div class="card-body">
			<?php
	...
	<div class="col-md-12">
		<div class="card my-2">
			<div class="card-header">Edit Soal Essay</div>
			<div class="card-body">
			<?php
