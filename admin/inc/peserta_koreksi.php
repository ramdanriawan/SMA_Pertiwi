...
<div class="col-md-12">
	<div class="card my-2">
	    <div class="card-header">
	        Data Siswa yang Mengikuti Tugas / Quiz &nbsp; <a href="?page=quiz" class="btn btn-danger btn-sm">Kembali</a>
	    </div>
	    <div class="card-body">
                            ...
                            <tr>
                            	...
                            	<td>
                                    ...
                                    if(mysqli_num_rows($sql_jwb) > 0) {
                                        ...
                                        echo "Tugas / Quiz ini tidak ada soal essay";
                                    } ?>
                            	</td>
                                <?php
                                ...
                                <td align="center" width="220px">
                                    ...
                                    if(mysqli_num_rows($sql_jwb) > 0) {
                                        if(mysqli_num_rows($sql_essay) > 0) { ?>
                                            <a href="?page=quiz&action=koreksi&hal=editessay&id_tq=<?php echo $id_tq; ?>&id_siswa=<?php echo $data_siswa_mengikuti_tes['id_siswa']; ?>&id_nilai=<?php echo $data_essay['id']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit Koreksi Essay</a>
                                        <?php
                                        } else { ?>
                                            <a href="?page=quiz&action=koreksi&hal=essay&id_tq=<?php echo $id_tq; ?>&id_siswa=<?php echo $data_siswa_mengikuti_tes['id_siswa']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Koreksi Jawaban Essay</a>
                                        <?php
                                        }
                                    } ?>
                                    <a onclick="return confirm('Yakin akan menghapus siswa ini dari daftar peserta ujian?');" href="?page=quiz&action=hapuspeserta&id_tq=<?php echo $id_tq; ?>&id_siswa=<?php echo $data_siswa_mengikuti_tes['id_siswa']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus Siswa dari Peserta Tugas / Quiz</a>
                                </td>
                            </tr>
    					<?php
    					}
