<section class="content-header mt-5">
  <div class="col-lg-12">
      <ol class="breadcrumb">
        <li><i class="fa fa-fw fa-receipt"></i> Data Mata Pelajaran</li>
      </ol>
   </div>
</section>
...
if(@$_SESSION[admin]) {
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="col-md-12">
            <div class="card my-2">
                <div class="card-header"><a href="?page=mapel&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a> &nbsp; <a href="./laporan/cetak.php?data=mapel" target="_blank" class="btn btn-default btn-sm">Cetak</a></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless table-hover" id="tb_mapel">
	                            ...
	                            while($data_mapel = mysqli_fetch_array($sql_mapel)) { ?>
	                                <tr>
	                                    ...
	                                    <td align="center" width="150px">
	                                        <a href="?page=mapel&action=edit&id=<?php echo $data_mapel['id']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
	                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=mapel&action=hapus&id=<?php echo $data_mapel['id']; ?>" class="btn btn-sm m-1   " style="background-color:#f00;">Hapus</a>
	                                    </td>
	                                </tr>
	                            <?php
	                            }
    ...
    <?php
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Tambah Data Mata Pelajaran &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Edit Data Mata Pelajaran &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
                    	<?php
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="col-md-12">
            <div class="card my-2">
                <div class="card-header">Mata Pelajaran yang Anda Ajar &nbsp; <a href="?page=mapel&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless table-hover" id="tb_mapel">
                            <thead class="thead-dark">
                            ...
                            if(mysqli_num_rows($sql_mapel_ajar) > 0) {
	                            while($data_mapel_ajar = mysqli_fetch_array($sql_mapel_ajar)) { ?>
	                                <tr>
	                                    ...
	                                    <td align="center" width="150px">
	                                        <a href="?page=mapel&action=edit&id=<?php echo $data_mapel_ajar[0]; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
	                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=mapel&action=hapus&id=<?php echo $data_mapel_ajar[0]; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
	                                    </td>
	                                </tr>
	                            <?php
	                            }
    ...
    <?php
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Tambah Mata Pelajaran yang Anda Ajar &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
                        <div class="form-group">
                            <label>Mapel *</label>
        ...
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Edit Mata Pelajaran yang Anda Ajar &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
	                    <?php
