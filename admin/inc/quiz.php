<section class="content-header mt-5">
	  <div class="col-lg-12">
		  <ol class="breadcrumb">
			<li><i class="fa fa-fw fa-clipboard"></i> Tugas / Quiz</li>
		  </ol>
	   </div>
</section>
...
if(@$_GET['action'] == '') { ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card my-2">
                <div class="card-header">Daftar Tugas / Quiz &nbsp; <a href="?page=quiz&action=tambah" class="btn btn-primary btn-sm">Tambah Tugas / Quiz</a> &nbsp; <a href="./laporan/cetak.php?data=topikquiz" target="_blank" class="btn btn-default btn-sm">Cetak</a></div>
                <div class="card-body">
                            ...
                            if(mysqli_num_rows($sql_topik) > 0) {
                                while($data_topik = mysqli_fetch_array($sql_topik)) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="?page=quiz&action=edit&id=<?php echo $data_topik['id_tq']; ?>" class="btn btn-sm m-1" style="background-color:#f60;">Edit</a>
                                            <a onclick="return confirm('Hati-hati saat menghapus topik quiz karena Anda akan menghapus semua data yang berhubungan dengan topik ini, termasuk data soal dan nilai. Apakah Anda tetap yakin akan menghapus topik ini?');" href="?page=quiz&action=hapus&id_tq=<?php echo $data_topik['id_tq']; ?>" class="btn btn-sm m-1" style="background-color:#f00;">Hapus</a>
                                            <br /><a href="?page=quiz&action=buatsoal&id=<?php echo $data_topik['id_tq']; ?>" class="btn btn-sm btn-dark m-1">Buat Soal</a>
                                            <a href="?page=quiz&action=daftarsoal&id=<?php echo $data_topik['id_tq']; ?>" class="btn btn-sm btn-dark m-1">Daftar Soal</a>
                                            <a href="?page=quiz&action=pesertakoreksi&id_tq=<?php echo $data_topik['id_tq']; ?>" class="btn btn-sm btn-dark m-1">Peserta & Koreksi</a>
                                        </td>
                                    </tr>
                                <?php
                                }
...
<?php
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Tambah Tugas / Quiz &nbsp; <a href="?page=quiz" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                    <form method="post">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card my-2">
                <div class="card-header">Edit Tugas / Quiz &nbsp; <a href="?page=quiz" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="card-body">
                <?php
