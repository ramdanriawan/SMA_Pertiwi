<section class="content-header mt-5">
            <div class="col-lg-12">
                  <ol class="breadcrumb">
                    <li><i class="fa fa-table"></i> Data Nilai</li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card my-2">
            ...
            ?>
            <div class="card-header">Data Nilai Tugas / Quiz Anda &nbsp; <?php if(mysqli_num_rows($sql_cek_nilai_pilgan) > 0) { ?><a href="./admin/laporan/cetak.php?data=nilaipersiswa" target="_blank" class="btn btn-default btn-sm">Cetak Nilai</a><?php } ?></div>
            <div class="card-body">
                <div class="table-responsive">
                	<table class="table table-striped table-borderless table-hover" id="tb_nilai">
                		<tr>
                			<th>#</th>
                			<th>Mata Pelajaran</th>
                			<th>Judul Tugas / Quiz</th>
                			<th>Presentase Nilai Pilihan Ganda</th>
                			<th>Presentase Soal Essay</th>
                			<th>Nilai Total</th>
                		</tr>
                		<?php
                			...
                			while($data_nilai_pilgan = mysqli_fetch_array($sql_cek_nilai_pilgan)) { ?>
                				<tr>
                					...
                					if(mysqli_num_rows($sql_cek_jawaban) > 0) {
										...
										<td>Tugas / Quiz ini tidak ada soal essay</td>
